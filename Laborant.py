...
bot = telebot.TeleBot("8029056152:AAEgXJMFQAN-THpbr45Wwkte7rwYVLQKCkg")  # токен нашего бота
...
@bot.message_handler(func=lambda
        message: message.text == 'Начать работу' or message.text == 'Главное меню' or message.text == 'Продолжить работу')
